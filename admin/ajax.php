...
$conditions['Active'] = array("Equals");
...
$conditions['Date_pending'] = array("On","Before","After","Before or On","After or On","Between dates","Pending");
  ...
  if($process_type == "select_fields")
  {
    ...
    switch($condition_type)
    {
      case "Active":
          $cont = "";
          foreach($conditions['Active'] as $val)
          {
              ...
              $selected1 = ($condition_value == 0)?"selected":"";
              $selected2 = ($condition_value == 1)?"selected":"";
              $cont .= "<option value='0' $selected1>Active</option>";
              $cont .= "<option value='1' $selected2>InActive</option>";
          break;
      ...
      case "Strict":
          ...
          {
              $element_name = "condition_value$field_count";
              if($selected_field != "cli_Assignedto" && $selected_field != "cli_AssignAustralia" && $selected_field != "cli_TeaminCharge" && $selected_field != "cli_SeniorInCharge" && $selected_field != "cli_TeamMember" && $selected_field != "cli_Salesperson")
              {
