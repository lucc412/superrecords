...
$conditions['Meeting'] = array("Equals");
  ...
  if($process_type == "select_fields")
  {
    ...
    switch($condition_type)
    {
      ...
      case "Strict":
          ...
          {
              $element_name = "condition_value$field_count";
              if($selected_field != "cso_generated_lead" && $selected_field != "cso_sales_person" && $selected_field != "cso_created_by" && $selected_field != "cso_modified_by" && $selected_field != "cso_contact_code")
              {
              ...
              else
              {
                  switch ($selected_field) {
                      case 'cso_generated_lead':
                          $staff_desig = "1=1";
                          break;
                      case 'cso_sales_person':
                          $staff_desig = "stf_staff.stf_Code<>'".$_SESSION[staffcode]."'";
                          break;
                      case 'cso_created_by':
                          $staff_desig = "1=1";
                          break;
                      case 'cso_modified_by':
                          $staff_desig = "1=1";
                          break;
                      case 'cso_contact_code':
                          $staff_desig = "1=1";
                          break;
                  }
