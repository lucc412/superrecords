  ...
  if($process_type == "select_fields")
  {
    ...
    switch($condition_type)
    {
      ...
      case "Strict":
          ...
          {
              $element_name = "condition_value$field_count";
              if($selected_field != "cas_StaffInCharge" && $selected_field != "cas_TeamInCharge" && $selected_field != "cas_ManagerInChrge" && $selected_field != "cas_SeniorInCharge" && $selected_field != "cas_Createdby" && $selected_field != "cas_Lastmodifiedby" && $selected_field != "cas_StatusCompletedby")
              {
              ...
              else
              {
                  switch ($selected_field) {
                      case 'cas_StaffInCharge':
                          $staff_desig = "1=1";
                          break;
                      case 'cas_TeamInCharge':
                          $staff_desig = "1=1";
                          break;
                      case 'cas_ManagerInChrge':
                          $staff_desig = "con_contact.con_Designation=17";
                          break;
                      case 'cas_SeniorInCharge':
                          $staff_desig = "1=1";
                          break;
                      case 'cas_Createdby':
                          $staff_desig = "1=1";
                          break;
                      case 'cas_Lastmodifiedby':
                          $staff_desig = "1=1";
                          break;
                      case 'cas_StatusCompletedby':
                          $staff_desig = "1=1";
                          break;
                  }
          ...
          else if($lookup_table1 != "" && $condition_value_type == "MultipleSelect")
          {
              $element_name = "condition_value$field_count";
              if($selected_field != "cas_StaffInCharge" && $selected_field != "cas_TeamInCharge" && $selected_field != "cas_ManagerInChrge" && $selected_field != "cas_SeniorInCharge" && $selected_field != "cas_Createdby" && $selected_field != "cas_Lastmodifiedby" && $selected_field != "cas_StatusCompletedby")
              {
              ...
              $element_name = "condition_value$field_count";
              $cont .= "~~<select name='".$element_name."' id='$element_name'>";
              $selected1 = ($condition_value == 1)?"selected":"";
              $selected2 = ($condition_value == 2)?"selected":"";
              $selected3 = ($condition_value == 3)?"selected":"";
              $cont .= "<option value='1' $selected1>Request</option>";
              $cont .= "<option value='2' $selected2>Issue</option>";
              $cont .= "<option value='3' $selected3>Internal</option>";
              $cont .= "</select>";
          }
          break;
      case "Date":
