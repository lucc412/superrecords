...
$clicode = array();
 $i=1;
 //$query_rsLimited = "SELECT id,name,cli_Code FROM jos_users ORDER BY name ASC";
   $query_rsLimited = "SELECT client_id AS id,client_name AS name FROM client ORDER BY client_name ASC";
