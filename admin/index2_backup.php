...
<br>
<table width="100%" cellpadding="3px" cellspacing="3px" style="border:1px solid #00699C; margin-left:1px;">
<tr>
...
<ul>
<li>Case status � Status dropdown values used in Case form under Administration to represent the status of cases. 
...
<li>Entity Type � Entity type dropdown values used in Client - > Quote sheet -> Card File Info tab to represent the type of Entity of the client.</li>
<li>Leave Request status � Status dropdown values used in Administration - > Leave Request form to represent the status of the leave request. For ex: Submitted, Approved, Declined etc</li>
<li>Process cycle � This represents processing cycle like Weekly, Monthly, Yearly etc which is used in Clients -> Quote sheet -> Tasks & Budgeted Hours tab</li>
<li>Priority - This represents the priorities of Cases and Worksheet. For ex: High, Medium, On Hold etc</li>
<li>Timesheet status � Status dropdown values used in Timesheet form. For ex: Submitted, Approved, Billed etc.</li>
...
Work flow activities menu items are used to configure the activities/tasks that are carried out in befree. This helps to standardize terminologies used. Adding/Updating values in Work flow activities Menu will reflect in the corresponding dropdown values in the forms used. Please note deleting any records in Work flow activities will affect corresponding forms. </li>
<ul>
<li>Master Activity � This represents activities like Bookkeeping,  Tax returns with respect to accounting purpose or can be used to represent internal activities like computer issues,  meetings etc. This is used in Worksheet, Timesheet, Cases forms </li>
<li>Sub Activity � The sub activities under Master Activity. For ex: GST under Tax Returns etc</li>
...
<li>Timesheet Task Templates � Timesheet task templates are used in Timesheet form. Users have an option to choose from the templates or write their own description. </li>
<ul>
</td>
<td width="50%" valign="top">
<h3>Clients Menu</h3>
<ul>
<li>Client status � This represents the status of the communication that is carried between client/lead and befree. For ex:  Appointment fixed, Waiting for confirmation etc</li>
<li>Manage Clients - Client contact details, Quotesheet information, Permanent Information are recorded in the client form.  </li>
Client Types can be � �Client�, �Lead� or �Discontinued�. Please note to add new types please inform us. </li>
A Lead record represents basic information like client company name, contact details, status etc. When a lead is confirmed and changed as Client type, additional fields/tabs will appear in the client record to input detailed information about the client, tasks that needs to carried out etc.  </li>
<li>Contacts � Contact records can be 2 types �Client� and �Employee�. Client type contacts represents contact person details of Clients.  Employee type contact represents befree user.</li>
</ul>
<br>
<h3>Administration</h3>
Administration form�s helps to manage, monitor and report internal work flow activities that is been carried out in befree.
<ul>
<li>Users � User form represents the login and permissions information for the users of the Work Flow System.</li>
<li>Leave Request Form- Users can submit Leave Request Form to request leave from the administrator.</li>
<li>Timesheets � Users record daily timesheets to represent their work done for Client/Clients each day.</li>
...
<ul>
<li>Timesheet Report � Advanced search filters are provided to search Timesheet records. Edit/Delete option is provide to correct the searched Timesheets.</li>
