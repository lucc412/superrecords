  function validation()
  {
        ...
        frm.action = "custom_cases_report.php?aid="+aid;
        frm.submit();
        return false;
  }
     ...
     $(document).ready(function() {
             ...
             $.ajax({
                ...
                success: function(msg){
                     ...
                     document.getElementById('cas_Title').value = sub;
...
function saveSubmit()
{
    ...
    var sub = document.getElementById('cas_Title').value;
    if(sub=="") {
        alert('Enter Report Name');
        document.getElementById('cas_Title').focus();
        return false;
    }
...
{
  document.form1.action = "custom_cases_report.php?page="+page;
