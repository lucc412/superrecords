...
function RenderCal()
{
    ...
    if (Cal.Scroller=="DROPDOWN")
    {
        ...
        //Year selector
        vCalHeader+="\n<td align='right'><a href=\"javascript:winMain.Cal.DecYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\"><img border=\"0\" src=\""+imgDir+"left.png\" alt=\"&lt;\"/></font></b></a><font face=\"Verdana\" color=\""+YrSelColor+"\" size=2><b> "+Cal.Year+" </b></font><a href=\"javascript:winMain.Cal.IncYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\"><img border=\"0\" src=\""+imgDir+"right.png\" alt=\"&gt;\"/></font></b></a></td></tr></table></td>\n";
        vCalHeader+="</tr>";
    }
...
function GenCell(pValue, pHighLight, pColor)//Generate table cell with value
{
    ...
    if (Cal.ShowTime)
    {
        ...
        vTimeStr="";        
    //PCellStr="<td "+vColor+" width="+CellWidth+" align='center'><font face='verdana' size='2'"+vHLstr1+"<a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+Cal.FormatDate(PValue)+"';"+vTimeStr+";if(winMain.document.getElementById('Description'))winMain.document.getElementById('Description').focus();window.close();\">"+PValue+"</a>"+vHLstr2+"</font></td>";
    PCellStr="<td "+vColor+" width="+CellWidth+" align='center'><font face='verdana' size='2'"+vHLstr1+"<a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+Cal.FormatDate(PValue)+"';"+vTimeStr+";if(winMain.document.getElementById('Description'))winMain.document.getElementById('Description').focus();winMain.document.getElementById('"+Cal.Ctrl+"').focus();window.close();\">"+PValue+"</a>"+vHLstr2+"</font></td>";
    return PCellStr;
}
