function validation()
  {
        ...
        frm.action = "sales_report.php?aid="+aid;
        frm.submit();
        return false;
  }
function saveCondition(scode,title)
{
     ...
     $(document).ready(function() {
             ...
             $.ajax({
                url: "custom_salesreport_ajax.php",
                type:"POST",
                async:true,
                ...
                success: function(msg){
                     ...
                     for(var j=1; j<(msg_field.length); j++) {
                        ...
                        select_fields(msg_field[j],msg_cond[j],msg_outval[j],j);
                     ...
                     document.getElementById('csr_Title').value = sub;
...
{
  document.form1.action = "sales_report.php?aid="+aid+"&page="+page;
...
function saveSubmit()
{
    ...
    var sub = document.getElementById('csr_Title').value;
    if(sub=="") {
        alert('Enter Report Name');
        document.getElementById('csr_Title').focus();
        return false;
    }
