...
function ComfirmCancel(){
   ...
   if(r==true){
      ...
      window.location.href = "pr_tasklist.php";
...
<?php
   //Get FormCode
  $formcode=$commonUses->getFormCode("Practice Items List");

//update client status order
        if(isset($_POST['gridedit']) && $_POST['gridedit']=="save")
        $sql_update_order =mysql_query("update `pr_tasklist` set `task_Order`=".$_POST['task_Order']." where task_Id=".$_POST['clscode']);
...
<div class="frmheading">
	<h1>Practice Items List</h1>
</div>
<form action="pr_tasklist.php" method="post">
...
<td><a href="pr_tasklist.php?a=reset" class="hlight">Reset Filter</a></td>
</tr>
</table>
</form><br /><br />
<p>&nbsp;</p>
<a href="pr_tasklist.php?a=add" class="hlight">
<?php 
  if($access_file_level['stf_Add']=="Y")
	  {  
?>
...
<tr class="fieldheader">
 ...
 <th class="fieldheader" align="left"><a   href="pr_tasklist.php?order=<?php echo "task_Description" ?>&type=<?php echo $ordtypestr ?>">Description</a></th>
 <th class="fieldheader"><a href="pr_tasklist.php?order=<?php echo "task_Order" ?>&type=<?php echo $ordtypestr ?>">Order</a></th>
...
?>
	<form action="pr_tasklist.php<?php echo $updatequery; ?>" method="post">
		<select name="task_Order" onChange="if(confirm('Save?')){this.form.gridedit.click();} else { location.href='pr_tasklist.php?a=reset'}"  ><option value="0">Select Order</option>
		<?php
			//$count = sql_getrecordcount();
		$count = mysql_num_rows($res);
			for($c=1; $c<=$count; $c++)
...
<a href="pr_tasklist.php?a=view&recid=<?php echo $i ?>">
...
<?php 
  if($access_file_level['stf_Edit']=="Y")
	  {  
?><td align="center">
<a href="pr_tasklist.php?a=edit&recid=<?php echo $i ?>">
...
<?php 
  if($access_file_level['stf_Delete']=="Y")
	  {  
?><td align="center">
<a onClick="performdelete('pr_tasklist.php?mode=delete&recid=<?php echo htmlspecialchars($row["task_Id"]) ?>'); return false;" href="#">
...
<a class="tooltip" href="#"><img src="images/help.png"><span class="help">Name of Practice Items List.</span></a>
</td>
</tr>
<tr>
<td class="hr">Order</td>
...
<tr>
 <?php if ($page > 1) { ?>
<td><a href="pr_tasklist.php?page=<?php echo $page - 1 ?>"><span style="color:#208EB3; ">&lt;&lt;&nbsp;</span></a>&nbsp;</td>
<?php } ?>
<?php
  global $pagerange;
...
<?php } else { ?>
<td><a href="pr_tasklist.php?page=<?php echo $j ?>"><span class="nav_links"><?php echo $j ?></span></a></td>
<?php } } } else { ?>
<td><a href="pr_tasklist.php?page=<?php echo $startpage ?>"><span class="nav_links"><?php echo $startpage ."..." .$count ?></span></a></td>
<?php } } } ?>
<?php if ($page < $pagecount) { ?>
<td>&nbsp;<a href="pr_tasklist.php?page=<?php echo $page + 1 ?>"><span class="nav_links">&nbsp;</span></a>&nbsp;</td>
<?php } ?>
</tr>
</table>
<?php } ?>
...
<tr>
 <?php if ($recid > 0) { ?>
<td><a href="pr_tasklist.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>"><span style="color:#208EB3; ">&lt;&nbsp;</span></a></td>
...
?>
<?php echo $title?> Practice Items List
</span>
<div class="frmheading">
	<h1></h1>
</div>
...
<form enctype="multipart/form-data" action="pr_tasklist.php" method="post" name="leadstatus" onSubmit="return validateFormOnSubmit()">
...
if($access_file_level['stf_Add']=="Y")
 {
?>
<td><a href="pr_tasklist.php?a=add" class="hlight">Add Record</a></td>
<?php } ?>
<?php
if($access_file_level['stf_Edit']=="Y")
 {
?>
<td><a href="pr_tasklist.php?a=edit&recid=<?php echo $recid ?>" class="hlight">Edit Record</a></td>
<?php } ?>
<?php
if($access_file_level['stf_Delete']=="Y")
 {
?>
<td><a onClick="performdelete('pr_tasklist.php?mode=delete&recid=<?php echo htmlspecialchars($row["task_Id"]) ?>'); return false;" href="#"  class="hlight">Delete Record</a></td>
<?php } ?>
</tr>
</table>
<?php
...
<br>
<form enctype="multipart/form-data" action="pr_tasklist.php?a=<?php echo $_GET['a']?>&recid=<?php echo $_GET['recid']?>" method="post" name="leadstatus" onSubmit="return validateFormOnSubmit()">
...
function sql_select()
{
  ...
  $sql = "SELECT `task_Id`, `task_Description`, `task_Order` FROM `pr_tasklist`";
...
function sql_insert()
{
  global $_POST;
  global $commonUses;
  $duplicate_entry=$commonUses->checkDuplicate('pr_tasklist','task_Description',str_replace("'","''",stripslashes(@$_POST["task_Description"])));
  if($duplicate_entry==0)
   {
  $sql = "insert into `pr_tasklist` (`task_Id`, `task_Description`,`task_Order`) values (" .$commonUses->sqlvalue(@$_POST["task_Id"], false).", '" .str_replace("'","''",stripslashes(@$_POST["task_Description"])) ."', " .$commonUses->sqlvalue(@$_POST["task_Order"], false).")";
...
function sql_update()
{
  global $_POST;
  global $commonUses;
  $sql = "update `pr_tasklist` set `task_Description`='" .str_replace("'","''",stripslashes(@$_POST["task_Description"])) ."',`task_Order`=" .$commonUses->sqlvalue(@$_POST["task_Order"], false)." where " .primarykeycondition();
  mysql_query($sql) or die(mysql_error());
}

function sql_delete($id)
{
   $sql = "delete from `pr_tasklist` where task_Id='".$id."'";
  if(!mysql_query($sql))
