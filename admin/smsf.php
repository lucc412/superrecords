...
.italicblue a,.italicblue a:visited
{
color:#FF9900;
text-decoration:none;
}
...
<div id="border-box">
<div id="container">
<div><img src="images/logo.jpg" width="155" height="77" class="logo" /></div><div class="brw"><img src="images/brwlogo.jpg" class="brw" /></div>
...
<div id="form">
  ...
  <tr>
    ...
    <td width="41%" valign="top"><table width="96%" border="0" cellspacing="2" cellpadding="2">
     ...
     <td width="2%" valign="top"style="background:url(images/dots.jpg) repeat-y;">&nbsp;</td>
      ...
      <ul class="points">
      <li>Capped Prices from <span class="blue">$85</span> plus GST of ANY SuperFund</li>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td colspan="3" valign="top"><div align="center"><span class="italicblue">Please Call us: 1300 8 7 3733 </span><strong>or</strong><span class="italicblue"> Email: <a href="mailto:info@befree.com.au">info@befree.com.au</a></span></div></td>
  </tr>
</table>
</form>
  <br />
