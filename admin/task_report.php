<?
/*	
	Created By -> 10-Apr-13 [Disha Goyal]
	Last Modified By -> 10-Apr-13 [Disha Goyal]	
	Description: This page is used for 'Task Report'	
*/
...
if($_SESSION['validUser']) {
	...
	//Get FormCode
	$formcode = $commonUses->getFormCode("Task Report");
	...
	if($access_file_level == 0) {
		...
		$_SESSION['ARRFIELDTYPEX'] = $objCallUsers->fetch_field_details('task','field_type');

		// function call to fetch title of each field 
		$_SESSION['ARRDISPFIELDS'] = $objCallUsers->fetch_field_details('task','field_title');

		// set name of the main table for this report page
		$reportPageName = 'task';

		// set name of the main table for this report page
		$reportPageTitle = 'Task Report';

		// set name of the main table for this report page
		$reportPageLink = 'task_report.php';
