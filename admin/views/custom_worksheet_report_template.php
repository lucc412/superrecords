...
include 'dbclass/custom_worksheet_report_class.php';
...
<table cellpadding="10" width="90%"  align="left">
 <tr>
    <td colspan="4" height="40" align="left"><span class="frmheading">Custom Worksheet Report</span></td>
  </tr>
                      <tr>
                                    <td><b>Choose the Report</b></td>
                                    <td>
                                        <select name="cwr_Report" onChange="return saveCondition('<?php echo $_SESSION['staffcode']; ?>',this.value)">
                                            <option value="0">Select the report</option>
                                            <?php
                                                $query = "SELECT cwr_Code,cwr_Title FROM cwr_customwrkreportsave WHERE cwr_SCode=".$_SESSION['staffcode'];
                                                $result = mysql_query($query);
                                                while($reptitle = mysql_fetch_array($result))
                                                {
                                                 if(($reptitle['cwr_Code']==$_POST['saveid'])) echo $sr = "selected"; else $sr = ""  ;
                                            ?>
                                            <option value="<?php echo $reptitle['cwr_Code']; ?>" <?php echo $sr; ?>><?php echo $reptitle['cwr_Title']; ?></option>
                                            <?php } ?>
                                        </select>
  ...
  <tr>
    <td colspan="4" height="20" align="left"><b>NOTE:</b>&nbsp; Please select atleast one conditions and outputs.</td>
                      ...
                      <tr>
                                    <?php
                                        $query = "SHOW TABLE STATUS LIKE 'cwr_customwrkreportsave'";
                                        $result = mysql_query($query);
                                    ...
                                    <td><input type="text" name="cwr_Title" id="cwr_Title" value="<?php echo $_POST['cwr_Title']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php if($_GET['aid'] && $_POST['cwr_Title']) { ?>
  ...
  <tr>
     <td colspan="4" height="50" align="center"><input type="button" name="view" value="Generate Report" onclick="return validation();" />&nbsp;&nbsp;<input type="button" name="view" value="Reset Filter" onclick="window.location='custom_worksheet_report.php';" />
    &nbsp;&nbsp;&nbsp;&nbsp;
    </td>
  </tr>
</table>
...
<script language="JavaScript" src="<?php echo $javaScript; ?>datetimepicker.js"></script>
	...
	<script type="text/javascript" src="<?php echo $javaScript; ?>ui.multiselect.js"></script>
        ...
        <script type="text/javascript" src="<?php echo $javaScript; ?>custom_worksheet_report.js"></script>
  <style>
    .multiselect {
height:300px;
width:550px;
