<?php 
     ...
     include 'dbclass/email_db_class.php';
     include 'dbclass/email_content_class.php';
        ...
        <html>
            <head>
                ...
                <LINK href="<?php echo $styleSheet; ?>tooltip.css" rel="stylesheet" type="text/css">
                 ...
                 <script type="text/javascript" src="<?php echo $javaScript ; ?>email_options.js"></script>
            </head>
            <body>
                ...
                <?php
                  //Get FormCode
                  $formcode=$commonUses->getFormCode("Email Options");
                 ...
                 $mode=@$_GET["mode"];
                  if($mode=="delete")
                     if($access_file_level['stf_Delete']=="Y")
                         {
                            $emailDbcontent->sql_delete($_REQUEST['recid']);
                         }
                         else
                         {
                  ...
                  switch ($sql) {
                    case "insert":
                      $emailDbcontent->sql_insert();
                      break;
                    case "update":
                      $emailDbcontent->sql_update();
                      break;
                   }
                  ...
                  switch ($a) {
                    ...
                    case "view":
                        if($access_file_level['stf_View']=="Y")
                          {
                            $emailContent->viewrec($recid ,$access_file_level);
                           }
                           else
                          {
                    ...
                    case "edit":
                     ...
                     default:
                          if($access_file_level['stf_View']=="Y")
                          {
                            $emailContent->select($access_file_level);
                          }
                           else
                          {
                            echo "You are not authorised to view the record.";
