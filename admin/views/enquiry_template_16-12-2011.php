...
<form name="enquiry"  class="enquiry" action="enquiry.php" method="post" _onsubmit="return captcha_validation();"  >
  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:13px;">
    ...
    <tr>
      <td width="28%" height="35" align="right" valign="middle" ><div align="left"><span>&nbsp;Post code</span> <font class="red">*</font></div></td>
      <td align="left" valign="middle" ><input name="post_code" type="text" id="post_code" size="45" maxlength="4" class="input-box" value="<?php echo $_POST['post_code']; ?>" />
        &nbsp;
        <div id="errphone" style="display:none; color:red; margin:0px 0px 0px 20px;">Required</div>
        <?php if ($errorphone) echo "<span class='red'>$errorTextphone</span>";?></td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td align="left" valign="middle"><br />
        <img src="securimage_show.php?sid"> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="SubmitForm" type="submit" id="ctl00_ContentPlaceHolder1_Submit1" class="contact_us_submit_button" value=""
      style="background: url(images/submit.png) no-repeat left center;width:84px;height:29px;border:0px;" />
        &nbsp;&nbsp;
        <input name="reset" type="reset" class="button" value="" id="Reset1" style="border:0px;background: url(images/reset.png) no-repeat left center;width:84px;height:29px;"/></td>
    </tr>
    <tr>
      <td><br/>
        <br></td>
...
<?php
  ...
  if(($_POST['cnt_name']!="" && $_POST['cmp_name']!="" && $_POST['email']!="" && $_POST['phone']!="" && $_POST['cnt_address']!="" && $_POST['states']!="" && $_POST['services']!="" && $_POST['other']!="" && $errorinvalid=="") || ($_POST['cnt_name']!="" && $_POST['cmp_name']!="" && $_POST['email']!="" && $_POST['phone']!="" && $_POST['cnt_address']!="" && $_POST['states']!="" && $_POST['services']!="" && $_POST['services']!="other" && $_POST['post_code']!="" && $errorinvalid==""))
      {
...
switch ($states)
{
   ...
   if($status==1)
    {
    echo "<script>
            parent.location.href = 'http://203.206.230.252:88/befree1/SuperRecordsApp/index.php?option=com_content&view=article&id=62';
            </script>";
      }
      }
