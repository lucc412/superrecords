...
<script src="captcha/js/freequote.js"></script>
...
table{ border:1px solid #00699C; }
   ...
   /*    function showForm($errorcnt_name=false,$errorcmp_name=false,$errorEmail=false,$errorphone=false,$errorcnt_address=false,$errorstates=false,$errorservices=false,$errorother=false,$errorinvalid=false){
      ...
      echo '<form action="free-quote.php" method="POST">';
      */
	  ?>
    <form name="freequote" action="free-quote.php" method="post" onSubmit="return checkCaptcha()">
	   <table  width="100%" border="0"  align="center" >
<tr>
                                                            <td colspan="2" align="center" height="25" style="color: #FFF; background-color: #00699C;">
                                                                <b><span style="color:white;">Request Free Quote!</span></b></td>
                                                        </tr>
                                     <tr>
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="middle">
                                            ...
                                            <div><img src="images/background.png" width="130" height="45" /><span style="font-weight:bold; font-size: 22px; letter-spacing: 2px; color: #37533d; position: relative; top: -12px; left: -118px; left /*\**/: -110px\9; top /*\**/: -15px\9;"><?php echo $_SESSION['captchaval']; ?></span></div>                                            
                                        </td>
                                    </tr>
                                     <tr>
                                     ...
                                     <td align="left" valign="middle">
                                         ...
                                         <div id="errsecurity" style="display:none; color:red; margin:0px 0px 0px 20px;">Required Security code</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;&nbsp;
                                            <input name="reset" type="reset" class="button" value="Clear" id="Reset1" onClick="return others()"  />
                                        <br/><br/>
                                        </td>
                                    </tr>
                             </table>
...
switch ($states)
{
    ...
    $userqry = mysql_query("INSERT INTO jos_users (`activation`,`cli_Type`,`name`,`email`,`block`,`cli_Phone`,`cli_DateReceived`,`cli_DayReceived`,`cli_PostalAddress`,`cli_State`,`cli_Notes`,`cli_Salesperson`,`cli_Createdby`,`cli_Createdon`,`cli_Lastmodifiedby`,`cli_Lastmodifiedon`) values ('FreequoteForm','4','".str_replace("'","''",$cmp_name)."','".str_replace("'","''",$email)."','1','".str_replace("'","''",$phone)."','".$Createdon."','".$day."','".str_replace("'","''",$cnt_address)."','".$state."','".str_replace("'","''",$comments)."','52','".str_replace("'","''",$cnt_name)."','".$Createdon."','".str_replace("'","''",$cnt_name)."','".$Createdon."')");
      // insert client Code
      if($userqry){
