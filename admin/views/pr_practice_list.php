...
<table  class="fieldtable" width="100%" align="center"  border="0" cellspacing="1" cellpadding="5">
	<tr class="fieldheader">
		<th width="12%" class="fieldheader" style="cursor:pointer;" align="left" onclick="changeSortImage('sort_code');">Practice Code <img id="sort_code" src="images/sort_asc.png"></th>
