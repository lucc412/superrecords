...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="middle" bgcolor="#F6F6F6">
                                             <img src="homecaptcha/captcha.php" class="form_captcha" style="display:none;" /> 
                                            <div><img src="images/background.png" width="130" height="45" /><span style="font-weight:bold; font-size: 22px; letter-spacing: 2px; color: #37533d; position: relative; top: -32px; left: 18px; "><?php echo $_SESSION['captchaval']; ?></span></div>
                                        </td>
                                    </tr>
                                     <tr>
