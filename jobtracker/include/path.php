...
define("HOLDINGTRUSTNAVIGATION",$_SERVER['DOCUMENT_ROOT'] . "/jobtracker/include/holding_trust_navigation.php");
define("HOLDINGTRUSTCONTENT",$_SERVER['DOCUMENT_ROOT'] . "/jobtracker/include/holding_trust_content.php");
