...
class SavedJobs {
	...
	public function fetch_saved_jobs() {
		...
		$qrySel = "SELECT t1.job_id, CONCAT_WS(' - ', c1.client_name, t1.period, sa.sub_Description)job_name, DATE_FORMAT(t1.job_created_date, '%d/%m/%Y') job_created_date, ss.subform_id, ss.subform_url
