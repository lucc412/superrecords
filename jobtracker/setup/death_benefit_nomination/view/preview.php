...
?><div class="pageheader">
    <h1>Preview</h1>
    <span><b>Welcome to the Super Records preview page for Death Benefit Nomination.</b><span>
</div><?
...
<div class="pdT20">
    <form name="objForm" action="preview.php">
        <span class="pdR20"><button type="button" onclick="window.location='nomination.php'" value="Back">Back</button></span>
