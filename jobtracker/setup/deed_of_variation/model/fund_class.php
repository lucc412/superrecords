...
class Fund 
{
    ...
    {
      $qryIns = "INSERT INTO dov_fund(job_id, fund_name, met_add_unit, met_add_build, met_add_street, met_add_subrb, met_add_state, met_add_pst_code, met_add_country, 
