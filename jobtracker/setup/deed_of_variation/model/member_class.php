...
class MEMBER 
{
    ...
    {
        $qry = "SELECT * FROM dov_member_details WHERE job_id = ".$_SESSION['jobId'];
    ...
    {
        $qryDel = "DELETE FROM dov_member_details WHERE member_id =". $member_id;
        mysql_query($qryDel);
    }
    
    public function insertMemberDtls($member)
    {
        $qry = "INSERT INTO dov_member_details (job_id, no_of_member, fname, mname, lname, dob, city_birth, cntry_birth, tfn, res_add)
