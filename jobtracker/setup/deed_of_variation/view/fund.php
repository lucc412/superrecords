...
?><form id="frmFund" method="post" action="fund.php">
    ...
    <table class="fieldtable" width="60%" cellpadding="10px;">
        ...
        <tr>
            ...
            <td>
                <input type="text" style="width:70px" id="txtDtVariation" readonly="true" name="txtDtVariation" size="10" value="<?=$arrFund['dt_variation']?>"/>
                <img src="<?=CALENDARICON?>" id="calImgId" onclick="javascript:NewCssCal('txtDtVariation','ddMMyyyy')" align="middle" class="calendar"/>
            </td>
        </tr>
        <tr>
            <td>Variation Clause</td>
            <td><input type="text" name="txtVarCls" id="txtVarCls" value="<?=$arrFund['variation_clause']?>"></td>
        </tr>
    </table>
