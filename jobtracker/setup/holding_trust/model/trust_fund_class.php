...
class Trust_Fund 
{
    ...
    {
      $qryIns = "INSERT INTO hbt_trust_fund(job_id, trust_name, trustee_id, comp_name, acn, reg_address, director, noofmember)
                    VALUES ( 
                    '".$_SESSION['jobId']."', 
                    '".addslashes($trust)."', 
                    ".$trusteeId.", 
    ...
    {
        $insMember="INSERT INTO hbt_indvdl_holding_fund (job_id, trustee_name, res_add) 
    ...
    {
        $updMember = "UPDATE hbt_indvdl_holding_fund 
    ...
    {
        $delMember = "DELETE FROM hbt_indvdl_holding_fund WHERE job_id = {$_SESSION['jobId']} AND indvdl_id IN ({$deleteMemberId})";
        //print $delMember;
    ...
    {
        $delMember = "DELETE FROM hbt_indvdl_holding_fund WHERE job_id = {$_SESSION['jobId']}";
        //print $delMember;
        mysql_query($delMember);
    }
