...
// content
?><form id="frmTrust" method="post" action="trust_fund.php">
    ...
    <div class="pdT20"><?
        ?><span class="pdR20"><button type="button" onclick="window.location='holding_trust.php'" value="Back">Back</button></span><?
