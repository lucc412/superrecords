...
class Preview {
    ...
    {
        $selQry="SELECT pension_id, job_id, member_name, DATE_FORMAT(dob, '%d/%m/%Y') dob, DATE_FORMAT(commence_date, '%d/%m/%Y') commence_date, condition_release, pension_acc_bal, condition_release, term_of_pension, tax_free_percnt, rev_pensn_name, rev_terms_condn
        ...
        $Pension = '<div class="test">Pension Details</div>
                ...
                <table class="first" cellpadding="4" cellspacing="6">
					...
					<tr>
                        ...
                        <td>'.$arrPension['condition_release'].'</td>
                    </tr>
					<tr>
                        <td>Term of Pension (years) : </td>
                        <td>'.$arrPension['term_of_pension'].'</td>
                    </tr>
                    <tr>
