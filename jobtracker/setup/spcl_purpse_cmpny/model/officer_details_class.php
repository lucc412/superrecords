...
class OFFICER_DETAILS 
{
    ...
    {
        $qryDel = "DELETE FROM spc_offcr_dtls WHERE offcr_id =". $offcr_id;
        mysql_query($qryDel);
    }
    
    public function insertOffcrDtls($offcr)
    {
        $qry = "INSERT INTO spc_offcr_dtls (job_id, no_of_offcr, offcr_fname, offcr_mname, offcr_lname, offcr_dob, offcr_city_birth, offcr_state_birth,
    ...
    public function updateOffcrDtls($offcr)
    {
        ...
        $qry = "UPDATE spc_offcr_dtls SET job_id = '".$_SESSION['jobId']."', 
