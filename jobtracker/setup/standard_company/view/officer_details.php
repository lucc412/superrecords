            ...
            <?php
                ...
                if(!empty($arrOffcrData))
                {
                    ...
                    { 
                        ...
                        ?>
							<input type="hidden" name="offcrId[<?=$cntr?>]" id="offcrId" value="<?=$value['offcr_id']?>"><div id="officer_<?=$cntr?>"> 
                            ...
                            <table class="fieldtable">
                                ...
                                <tr>
                                    <td>Date of birth </td>
                                    <td><input type="text" id="txtDob_<?=$cntr?>" name="txtDob[<?=$cntr?>]" value="<?=$value['offcr_dob']?>" readonly="" /><img src="../../images/calendar.png" id="calImgId" onclick="javascript:NewCssCal('txtDob_<?=$cntr?>','ddMMyyyy','dropdown',false,24,false,'past')" align="middle" class="calendar"/></td>
                                </tr>
                                <tr>
                                    <td>City of birth </td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="selSob_<?=$cntr?>" name="selSob[<?=$cntr?>]" value="<?=$value['offcr_state_birth']?>" />
