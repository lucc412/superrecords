...
class PENSION {
    ...
    {
        $qryIns = "INSERT INTO trp_pension_dtls(job_id, member_name, dob, commence_date, pension_acc_bal, currnt_yr_pay, tax_free_percnt, rev_pensn_name, rev_terms_condn)
                    VALUES (
                    '".$_SESSION['jobId']."',
    ...
    {
        $qryUpd = "UPDATE trp_pension_dtls
    ...
    {
        $selQry="SELECT pension_id, job_id, member_name, DATE_FORMAT(dob, '%d/%m/%Y') dob, DATE_FORMAT(commence_date, '%d/%m/%Y') commence_date, pension_acc_bal, currnt_yr_pay, tax_free_percnt, rev_pensn_name, rev_terms_condn
