...
class TRUSTEE 
{
    ...
    {
      $qryIns = "INSERT INTO trp_trusty_dtls(job_id, trusty_type, no_of_members)
                    VALUES ( 
                    '".$_SESSION['jobId']."', 
    ...
    {
        $insMember="INSERT INTO trp_indvdl_trusty_dtls (job_id, fname, mname, lname, res_add) 
    ...
    {
        $updMember = "UPDATE trp_indvdl_trusty_dtls 
    ...
    {
        $insMember="INSERT INTO trp_corp_trusty_dtls (job_id, comp_name, acn, reg_add, directors) 
                                VALUES({$_SESSION['jobId']},
    ...
    {
        $updMember = "UPDATE trp_corp_trusty_dtls 
    ...
    {
        $delMember = "DELETE FROM trp_indvdl_trusty_dtls WHERE job_id = {$_SESSION['jobId']} AND indvdl_id IN ({$deleteMemberId})";
       // print $delMember;
    ...
    {
        $delMember = "DELETE FROM trp_indvdl_trusty_dtls WHERE job_id = {$_SESSION['jobId']}";
       // print $delMember;
        mysql_query($delMember);
    }
    ...
    {
        $delMember = "DELETE FROM trp_corp_trusty_dtls WHERE job_id = {$_SESSION['jobId']}";
       // print $delMember;
        mysql_query($delMember);
    }
