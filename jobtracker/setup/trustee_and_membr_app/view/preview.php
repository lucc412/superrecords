...
?><div class="pageheader">
    <h1>Preview</h1>
    <span><b>Welcome to the Super Records preview page for Consent to Act as Trustee and Member Application.</b><span>
</div><?
...
<div class="pdT20">
    <form name="objForm" action="preview.php">
        <span class="pdR20"><button type="button" onclick="window.location='company_details.php'" value="Back">Back</button></span>
