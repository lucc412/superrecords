...
class modjoomEmailForm {
	...
	$this->_obj->namelbl =      $params->get('bnamelbl');
	$this->_obj->companylbl =   $params->get('bcompanylbl');
	$this->_obj->phonelbl =     $params->get('bphonelbl');
	$this->_obj->websitelbl =   $params->get('bwebsitelbl');
	$this->_obj->messagelbl =   $params->get('bmessagelbl');
	$this->_obj->filelbl =      $params->get('bfilelbl');
	$this->_obj->mobilelbl =    $params->get('bmobilelbl');
	...
	$this->_obj->Emaillbl =     $params->get('bEmaillbl');
	$this->_obj->thankmsg =     $params->get('thankmsg');
	//custom field
	$this->_obj->customfirst =     $params->get('customfieldfirst');
	$this->_obj->customfieldsecond =     $params->get('customfieldsecond');
		// Get XML params
	...
	function _sendmail(){
		...
		$this->_obj->body .= (isset($_POST['customfieldfirst']))  ? "\n" .$this->_obj->customfirst . ":\n" . htmlspecialchars($_POST['customfieldfirst']) : "";
		$this->_obj->body .= (isset($_POST['customfieldsecond']))  ? "\n" .$this->_obj->customfieldsecond . ":\n" . htmlspecialchars($_POST['customfieldsecond']) : "";
