	...
	if(count($arrJobs) == 0) {
		...
		?><table width="100%" class="resources">
			<tr>
				...
				<td class="td_title">Checklist</td>
				...
				?><tr class="<?=$trClass?>"><?
					...
					<td class="tddata"><?
						...
						if(!empty($arrJobDetails['checklist']) && file_exists($folderPath)) {
							?><p><a href="jobs.php?a=download&filePath=<?=$arrJobDetails['checklist']?>&flagChecklist=C" title="Click to view this document">Checklist</a></p><?
						}
					?></td>
